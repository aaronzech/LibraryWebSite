...
<section class="main-container">
	<div class="main-wrapper">
		<H2> Book Info </H2>
			<img src="/LoginSystemTest/BookCovers/cats.jpg" alt="HTML5 Icon" style="width:128px;height:150px" align="middle">
	</div>
</section>
...
FROM books
INNER JOIN author
ON books.authorID = author.authorID WHERE books.isbn = 9781620311219
...
$sql = "Select * from books where bookID NOT IN (Select bookID from borrowed)AND isbn = 9781620311219";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		<form action=9781620311219.php method=post>
